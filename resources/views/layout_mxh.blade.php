...
<link rel='stylesheet' id='bootstrap-css' href='{{ URL::to('/themes/css/bootstrap.min.css') }}' type='text/css'
    media='all' />
<link rel='stylesheet' id='bootstrap-theme-css' href='{{ URL::to('/themes/css/bootstrap-theme.min.css') }}'
    type='text/css' media='all' />
<link rel='stylesheet' id='jquery-ui-css' href='{{ URL::to('/themes/css/jquery-ui.min.css') }}' type='text/css'
    media='all' />
<link rel='stylesheet' id='owl-carousel-css' href='{{ URL::to('/themes/css/owl.carousel.min.css') }}'
    type='text/css' media='all' />
<link rel='stylesheet' id='s7upf-color-css' href='{{ URL::to('/themes/css/color.css') }}' type='text/css'
    media='all' />
...
<link rel='stylesheet' id='s7upf-responsive-css' href='{{ URL::to('/themes/css/lib/responsive.css') }}'
    type='text/css' media='all' />
                                    ...
                                    <div class="text-logo">
                                        <a href="{{ URL::to('/') }}">
                                            <ul class="list-inline-block">
                                                <li>
                                                    <img class="wp-image-316 aligncenter"
                                                    src="{{ URL::to('/frontend/images/logopet.jpg') }}"
                        ...
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                <div class="oasc" style="display: flex;margin-bottom: 20px;">
                                    <nav class="main-nav  main-nav1 menu-sticky-on" style="display: flex">
                                        <ul id="menu-home-menu" class="list-none">
                                            ...
                                            @else
                                                <li id="nav-menu-item-1393" style="margin-inline: 20px"
                                                    class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-1276 current_page_item">
                                                    <a href="{{ route('Login') }}"
                                                       class="menu-link main-menu-link">{{ __('Login') }}</a>
                                                </li>
                                            @endif
                                        </ul>
                                        ...
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                ...
                                                <div
                                                    ...
                                                    <form action="{{ route('SearchMXH') }}" method="GET"
                                                        autocomplete="off"
                            ...
                            <div class="wpb_wrapper">
                                ...
                                <div
                                    ...
                                    <form class="search-form  main-search-form vc_custom_1584529729542 live-search-on"
                                        ...
                                        <input name="s" onblur="if (this.value=='') this.value = this.defaultValue"
                                ...
                                <div class="s7upf-slider adv-footer-slider ">
                                    <div class="wrap-item sv-slider  " data-item="8" data-speed="5000"
                                        ...
                                        <div class="item-adv-footer  ">
                                            <a href="#" class="wobble-horizontal"><img width="150" height="185"
                                                    src="{{ URL::to('/themes/image/dog1.png') }}"
                                        ...
                                        <div class="item-adv-footer  ">
                                            <a href="#" class="wobble-horizontal"><img width="150" height="185"
                                                    src="{{ URL::to('/themes/image/dog2.png') }}"
                                                    class="attachment-full size-full" alt="" /></a>
                                            <div class="info-adv-footer">
                                        ...
                                        <div class="item-adv-footer  ">
                                            <a href="#" class="wobble-horizontal"><img width="150" height="185"
                                                    src="{{ URL::to('/themes/image/dog3.png') }}"
                                                    class="attachment-full size-full" alt="" /></a>
                                            <div class="info-adv-footer">
                                        ...
                                        <div class="item-adv-footer  ">
                                            <a href="#" class="wobble-horizontal"><img width="150" height="185"
                                                    src="{{ URL::to('/themes/image/dog4.png') }}"
                                                    class="attachment-full size-full" alt="" /></a>
                                            <div class="info-adv-footer">
                                        ...
                                        <div class="item-adv-footer  ">
                                            <a href="#" class="wobble-horizontal"><img width="150" height="185"
                                                    src="{{ URL::to('/themes/image/dog5.png') }}"
                                                    class="attachment-full size-full" alt="" /></a>
                                            <div class="info-adv-footer">
                                        ...
                                        <div class="item-adv-footer  ">
                                            <a href="#" class="wobble-horizontal"><img width="150" height="185"
                                                    src="{{ URL::to('/themes/image/dog6.png') }}"
                                                    class="attachment-full size-full" alt="" /></a>
                                            <div class="info-adv-footer">
                                                <h3 class="title18">Bull Pháp</h3>
                                                <p class="desc"></p>
                                        ...
                                        <div class="item-adv-footer  ">
                                            <a href="#" class="wobble-horizontal"><img width="150" height="185"
                                                    src="{{ URL::to('/themes/image/dog7.png') }}"
                                                    class="attachment-full size-full" alt="" /></a>
                                            <div class="info-adv-footer">
                                        ...
                                        <div class="item-adv-footer  ">
                                            <a href="#" class="wobble-horizontal"><img width="150" height="185"
                                                    src="{{ URL::to('/themes/image/dog8.png') }}"
                                                    class="attachment-full size-full" alt="" /></a>
                                            <div class="info-adv-footer">
...
{{--                                            <i class="fa-solid fa-map" style="color: #b04aa3;"></i>--}}
                                            <p class="desc"><i class="icon ion-map fa-solid fa-map"></i><strong>Địa chỉ:
                                                </strong>Số 34 Dốc Lã - Yên Thường - Gia Lâm - Hà Nội</p>
                                            <p class="desc"><i
                                                    class="icon ion-ios-telephone"></i><strong>Điện thoại</strong>: <a
                                                    class="hai01" href="tel:0939.86.36.96">0972.25.82.81</a>
                                            </p>
                                            <p class="desc"><i
                                                    class="icon ion-ios-email"></i><strong>Email</strong>: <a
                                                    href="mailto:contact.7uptheme@gmail.com">minhvuongnguyen1111@gmail.com</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="wpb_column column_container col-sm-3">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                ...
                                <div class="wpb_raw_code wpb_content_element wpb_raw_html">
                                    <div class="wpb_wrapper">
                                        <a href="https://www.facebook.com/vuong257">Minh Vương</a>
{{--                                        <iframe--}}
{{--                                            src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fmatpetfamily&amp;tabs&amp;width=270&amp;height=154&amp;small_header=true&amp;adapt_container_width=true&amp;hide_cover=true&amp;show_facepile=true&amp;appId=1446807022289005"--}}
{{--                                            width="270" height="154" style="border:none;overflow:hidden" scrolling="no"--}}
{{--                                            frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>--}}
    ...
    <script type='text/javascript' src='{{ URL::to('/themes/js/mouse.min.js') }}'></script>
    <script type='text/javascript' src='{{ URL::to('/themes/js/slider.min.js') }}'></script>
    <script type='text/javascript' src='{{ URL::to('/themes/js/imagesloaded.min.js') }}'></script>
    <script type='text/javascript' src='{{ URL::to('/themes/js/owl.carousel.min.js') }}'></script>
    <script type='text/javascript' src='{{ URL::to('/themes/js/theme.js') }}'></script>
    <script type='text/javascript' src='{{ URL::to('/themes/js/script.js') }}'></script>
    <script type='text/javascript' src='{{ URL::to('/themes/js/ajax.js') }}'></script>
    <script type='text/javascript' src='{{ URL::to('/themes/js/js_composer_front.min.js') }}'></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <script>
        show_cart();
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.data == false) {
                            ...
                            icon: 'error',
                            title: 'Oops...',
                            text: 'Số lượng trong kho không đủ để gửi hàng, chúng tôi sẽ xóa giỏ hàng của bạn, xin lỗi đã làm phiền!',
                            }.then()=> {
                                window.location.href = 'http://ljshop.net/camera/trang-chu';
                            });
                            ...
                            alert('Số lượng không được để âm và là số nguyên');
                            window.location.href = 'http://ljshop.net/camera/trang-chu';
                        }
                        // swal(
    ...
    <script type="text/javascript" src="{{ asset('/frontend/js/jquery.lighter.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/frontend/js/lightslider.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/frontend/js/prettify.js') }}"></script>
