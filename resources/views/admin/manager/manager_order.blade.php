                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($or->order_status==2)
                                    Đã xác nhận đơn hàng và đang giao
                            ...
                            <td>
                                <a href="{{URL::to('/view-order/'.$or->order_code)}}" class="active" ui-toggle-class=""><i
                                        class="fa fa-eye text-success text-active"></i></a>
                                <a onclick="return confirm('Bạn có muốn xóa?')"
                                   href="{{URL::to('/delete-order/'.$or->order_code)}}" class="active"
