                                                  ...
                                                  ?>
                                                    ...
                                                    <li id="nav-menu-item-2513"
                                                        ...
                                                        <a href="{{ URL::to('/changepass/'. Session::get('customer_id')) }}"
                                                            class="menu-link sub-menu-link">{{ __('Password') }}</a>
                                                    </li>
                                                    <?php
                                                }else {}
                                                    ?>
                                    ...
                                    <div class="footer-box">
                                        ...
                                        <div class="contact-footer">
                                            ...
                                            <p class="desc"><i
                                                    ...
                                                    class="hai01" href="tel:0778.96.04.01">097.225.82.81</a>
                                            </p>
                                            <p class="desc"><i
                                                    class="icon ion-ios-email"></i><strong>Email</strong>: <a
                                                    href="mailto:contact.minhvuongnguyen1111@gmail.com">minhvuongnguyen1111@gmail.com</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
