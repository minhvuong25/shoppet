...
<head>
    ...
    {{--            <link rel='stylesheet' id='font-ionicons-css-css' href='{{ URL::to('/themes/css/ionicons.min.css') }}'--}}
    {{--                  type='text/css' media='all'/>--}}
    <link rel='stylesheet' id='bootstrap-css' href='{{ URL::to('/themes/css/bootstrap.min.css') }}'
          type='text/css' media='all'/>
    <link rel='stylesheet' id='bootstrap-theme-css' href='{{ URL::to('/themes/css/bootstrap-theme.min.css') }}'
          type='text/css' media='all'/>
    <link rel='stylesheet' id='jquery-ui-css' href='{{ URL::to('/themes/css/jquery-ui.min.css') }}'
          type='text/css' media='all'/>
                                    ...
                                    <ul id="menu-home-menu" class="list-none">
                                        ...
                                        <li id="nav-menu-item-2512"
                                            ...
                                            <ul class="sub-menu menu-odd  menu-depth-1">
                                                ...
                                                <li id="nav-menu-item-2513"
                                                    class="sub-menu-item  menu-item-odd menu-item-depth-1 menu-item menu-item-type-taxonomy menu-item-object-product_cat">
                                                    <a href="{{ URL::to('/changepass/'. Session::get('customer_id')) }}"
                                                       class="menu-link sub-menu-link">{{ __('Đổi Mật khẩu') }}</a>
                                                </li>
                                                    <?php
                                                } else {
                                                }
...
{{--                                            </div>--}}
                                            <div
                                                ...
                                                <form action="{{ URL::to('/timkiem') }}" method="GET"
                                                    ...
                                                    <input required class="col-md-12 longer-input" name="keyword" placeholder="Tìm kiếm..." type="text" id="keyword">
                            ...
                            <div class="custom-information  ">
                                <div class="footer-box">
                                    ...
                                    <div class="contact-footer">
                                        ...
                                        <p class="desc"><i
                                                class="icon ion-ios-telephone"></i><strong>Điện thoại</strong>:
                                            <span>097.225.8281</span>
                                        </p>
                                        <p class="desc"><i
                                                class="icon ion-ios-email"></i><strong>Email</strong>:
                                            <span>minhvuongnguyen1111@gmail.com</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="vc_column-inner">
                        <div class="wpb_wrapper">
                            ...
                            <div class="wpb_raw_code wpb_content_element wpb_raw_html">
                                <div class="wpb_wrapper">
                                    <div class="fb-page"
                                         data-href="https://www.facebook.com/vuong257"
                                         data-tabs="timeline" data-width="" data-height="50" data-small-header="true"
...
<script>
    $(document).ready(function () {
        $('.send_order').click(function () {
            ...
            if (order_fee == '') {
                swal(
                    "Bạn chưa chọn địa điểm giao hàng !!!"
                );
                return;
            }
            if (shipping_name == '' || shipping_email == '' || shipping_address == '' | shipping_phone == '') {
                swal(
                    "Bạn chưa điền đủ thông tin người nhận !!!"
                );
                return;
            }
            $.ajax({
